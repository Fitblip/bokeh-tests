...
# be anything you like, but it needs to have the same length as N (the size of both x and y).
N = len(x)

foo = list(itertools.permutations("ABCDEF"))[:N]
bar = list(itertools.permutations("ZYXWVU"))[:N]
...
# inside the circle
text(
    x,y,inds,alpha=0.5, text_font_size="10pt",
