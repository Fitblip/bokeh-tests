...
TOOLS_2 = "reset,previewsave"
TOOLS_3 = "pan,wheel_zoom"
...
scatter(x1, y1, size=12, line_color="red", fill_color="black", alpha=0.5,
        x_range=xr, y_range=yr, tools=TOOLS)

scatter(x2, y2, size=12, line_color="blue", fill_color="black", alpha=0.5,
        x_range=xr, y_range=yr, tools=TOOLS_2)

scatter(x3, y3, size=12, line_color="green", fill_color="black", alpha=0.5,
        x_range=xr, y_range=yr, tools=TOOLS_3)
...
circle(x=x,y=y,fill_color=colors, line_color=None, radius=radii, fill_alpha=.8, tools=TOOLS)
